...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
	...
	<div class="container">
        <h2 style="color:white; font-family: Cooper Black,serif; font-size: 200%; background-color:black;" class="text-center pt-4">Transaction</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
        ...
        <div>
        <label style="color:white; font-family: Cooper Black,serif;" >Transfer From:</label>
        ...
        <br><br><br>
        <label style="color:white; font-family: Cooper Black,serif;">Transfer To:</label>
        ...
        <div style="margin:auto;">
            <label style="color:white; font-family: Cooper Black,serif;" >Amount:</label>
